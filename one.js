...
for (var i = 0; i < inks.length; i++) {
	var link = inks[i];
	link.setAttribute('onclick', 'changes(this)')
}

function changes(imog) {
	 document.body.style.backgroundImage = "url('"+imog.getAttribute('src')+"')";
}
...
document.addEventListener('DOMContentLoaded', function() {
	...
	/* omg please clean up this kak code kanala */
